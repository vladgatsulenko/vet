...
final class Version20251118180255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void //todo: refuctor split <<<'SQL'....SQL) 
    {
        ...
        $this->addSql('CREATE TABLE product_manual (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, text LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_72A7FF604584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
